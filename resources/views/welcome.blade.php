...
<head>
    ...
    <title>
        Kantor urusan internasional Universitas YARSI
    </title>
    ...
    <style>
        .gradient {
            background: linear-gradient(90deg, #33d556 0%, #4ba9ce 100%);
        }
    </style>
</head>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20"
                ...
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    @if (Route::has('login'))
                        ...
                        @else
                            <li class="mr-3">
                                <a class="inline-block py-2 px-4 text-black font-bold no-underline hover:text-gray-800 hover:text-underline py-2 px-4"
        ...
        <div class="container max-w-5xl mx-auto m-8">
            ...
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    <div class=" flex flex-row justify-beetwen Sgrid grid-cols-5 grid-rows-5 gap-4">
                        <div >
